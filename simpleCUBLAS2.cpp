...
int main(int argc, char **argv)
{
    ...
    h_A = (float *)malloc((M*K) * sizeof(h_A[0]));	//size is m*k
    ...
    /****Print the value of device matrices***************/
    ...
    status = cublasSgemm(handle, CUBLAS_OP_N, CUBLAS_OP_N, M, N, K, &alpha, d_A, K, d_B, N, &beta, d_C, N);
